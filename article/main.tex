...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|l|}
        ...
        Thresholding         & Threshold Value                                                                                                                                         & 70, 100, 127, 200, 220, 255             \\
                             ...
                             & \multicolumn{2}{l|}{\textit{Method:} 'fixed' uses a constant threshold; 'adaptive mean' and 'adaptive gaussian' use local statistics for thresholding.}                                           \\
        \hline
...
\begin{itemize}
    ...
    \item \textbf{Model Architectures:} For each preprocessed dataset, a range of neural network models were trained:
          \begin{itemize}
              \item A custom convolutional neural network (CNN) with three convolutional layers, max pooling, and dense layers.
              \item Transfer learning models based on popular architectures, each with the convolutional base frozen and custom dense layers added for classification. The tested architectures included:
                    \begin{itemize}
                        \item ResNet50
                        \item DenseNet121
                        \item EfficientNetB3
