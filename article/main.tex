...
\begin{table}[H]
    ...
    \begin{adjustbox}{center,max width=\textwidth}
        \begin{tabular}{|l|l|l|c|c|}
            ...
            CLAHE                  & NASNetMobile   & tile grid size=(5, 5), iterations=2  & 0.290                 & 0.850              \\
            \hline
        \end{tabular}
    \end{adjustbox}
    \caption{Top results for best tested preprocessing and respective model combinations. The table shows the preprocessing method, best model architecture, parameters used, best validation accuracy (Top-1), and Top-K accuracy (with K=3).}
...
The full code and data processing pipeline for this study are available at \url{https://github.com/PepeuFBV/breast_cancer_analysis}.
